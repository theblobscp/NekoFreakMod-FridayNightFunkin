...
HX_DEFINE_STACK_FRAME(_hx_pos_3fccbae956d84d25_447_new,"AccuracyDOption","new",0xe62cee92,"AccuracyDOption.new","Options.hx",447,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_453_press,"AccuracyDOption","press",0xad8ae235,"AccuracyDOption.press","Options.hx",453,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_461_updateDisplay,"AccuracyDOption","updateDisplay",0xd1d41feb,"AccuracyDOption.updateDisplay","Options.hx",461,0x9d9a0240)

void AccuracyDOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_447_new)
HXLINE( 448)		super::__construct();
HXLINE( 449)		this->description = desc;
            	}
...
bool AccuracyDOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_453_press)
HXLINE( 454)		 ::Dynamic _hx_tmp;
HXDLIN( 454)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),1 )) {
HXLINE( 454)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 454)			_hx_tmp = 1;
            		}
HXDLIN( 454)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyMod",09,b2,8a,86),_hx_tmp,::hx::paccDynamic);
HXLINE( 455)		this->display = this->updateDisplay();
HXLINE( 456)		return true;
            	}


::String AccuracyDOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_461_updateDisplay)
HXDLIN( 461)		::String _hx_tmp;
HXDLIN( 461)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),0 )) {
HXDLIN( 461)			_hx_tmp = HX_("Accurate",14,d1,76,d9);
            		}
            		else {
HXDLIN( 461)			_hx_tmp = HX_("Complex",10,8e,c2,50);
            		}
HXDLIN( 461)		return (HX_("Accuracy Mode: ",d0,5b,59,26) + _hx_tmp);
            	}
