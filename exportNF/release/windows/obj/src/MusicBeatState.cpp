...
HXDLIN(  33)			_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_nekofreak/MusicBeatState.hx",9d,bc,1a,2e),33,HX_("MusicBeatState",76,df,84,5d),HX_("create",fc,66,0f,7c)));
            		}
...
HXLINE(  73)		if (::hx::IsNotEq( ::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->getFPSCap_dyn(),::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic) )) {
