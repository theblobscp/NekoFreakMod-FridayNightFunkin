...
HX_DEFINE_STACK_FRAME(_hx_pos_c83b011b1ca270a7_79_new,"DFJKOption","new",0xfb5a698a,"DFJKOption.new","Options.hx",79,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c83b011b1ca270a7_85_press,"DFJKOption","press",0x85470b2d,"DFJKOption.press","Options.hx",85,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c83b011b1ca270a7_99_updateDisplay,"DFJKOption","updateDisplay",0xd7d600e3,"DFJKOption.updateDisplay","Options.hx",99,0x9d9a0240)

void DFJKOption_obj::__construct( ::Controls controls){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_79_new)
HXLINE(  80)		super::__construct();
HXLINE(  81)		this->controls = controls;
            	}
...
bool DFJKOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_85_press)
HXLINE(  86)		::flixel::FlxG_obj::save->data->__SetField(HX_("dfjk",c3,18,67,42),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(  88)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )) {
HXLINE(  89)			this->controls->setKeyboardScheme(::KeyboardScheme_obj::Solo_dyn(),true);
            		}
            		else {
HXLINE(  91)			this->controls->setKeyboardScheme(::KeyboardScheme_obj::Duo(true),true);
            		}
HXLINE(  93)		this->display = this->updateDisplay();
HXLINE(  94)		return true;
            	}


::String DFJKOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_99_updateDisplay)
HXDLIN(  99)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )) {
HXDLIN(  99)			return HX_("DFJK",c3,e0,27,2d);
            		}
            		else {
HXDLIN(  99)			return HX_("WASD",1b,2b,b3,39);
            		}
