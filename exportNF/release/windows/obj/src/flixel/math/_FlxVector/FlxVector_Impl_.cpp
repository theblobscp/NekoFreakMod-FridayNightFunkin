...
HXLINE( 487)		this1->set_x((this1->x * ( (Float)(-1) )));
HXLINE( 488)		this1->set_y((this1->y * ( (Float)(-1) )));
...
HXDLIN( 494)		this2->set_x((this2->x * ( (Float)(-1) )));
HXDLIN( 494)		this2->set_y((this2->y * ( (Float)(-1) )));
...
HXDLIN( 583)					_this->set_x((_this->x - a->x));
HXDLIN( 583)					_this->set_y((_this->y - a->y));
            				}
...
HXDLIN( 607)			_this->set_x((_this->x - a->x));
HXDLIN( 607)			_this->set_y((_this->y - a->y));
            		}
...
HXDLIN( 622)					_this->set_x((_this->x - a->x));
HXDLIN( 622)					_this->set_y((_this->y - a->y));
            				}
...
HXDLIN( 659)					_this->set_x((_this->x - a->x));
HXDLIN( 659)					_this->set_y((_this->y - a->y));
            				}
...
HXDLIN( 660)					_this->set_x((_this->x - b->x));
HXDLIN( 660)					_this->set_y((_this->y - b->y));
            				}
...
HXLINE( 758)		this1->set_x((this1->x - (d * normal->x)));
HXLINE( 759)		this1->set_y((this1->y - (d * normal->y)));
