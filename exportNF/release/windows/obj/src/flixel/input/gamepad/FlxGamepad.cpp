...
HXLINE( 724)		if (::hx::IsPointerEq( this->deadZoneMode,::flixel::input::gamepad::FlxGamepadDeadZoneMode_obj::CIRCULAR_dyn() )) {
...
HXLINE( 734)		if (::hx::IsPointerEq( this->deadZoneMode,::flixel::input::gamepad::FlxGamepadDeadZoneMode_obj::CIRCULAR_dyn() )) {
...
HXDLIN( 773)		if (::hx::IsPointerNotEq( stick3->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() )) {
HXLINE( 773)			_hx_tmp = ::hx::IsPointerEq( stick3->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
...
HXLINE( 778)			bool _hx_tmp = ::hx::IsPointerEq( stick3->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() );
            		}
            	}
