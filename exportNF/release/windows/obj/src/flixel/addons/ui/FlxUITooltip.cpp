...
HXLINE( 148)		 ::flixel::addons::ui::AnchorPoint fh = this->_anchorArrow->x;
HXDLIN( 148)		fh->offset = (fh->offset - this->anchor->x->offset);
HXLINE( 149)		 ::flixel::addons::ui::AnchorPoint fh1 = this->_anchorArrow->y;
HXDLIN( 149)		fh1->offset = (fh1->offset + this->anchor->y->offset);
...
HXLINE( 162)			 ::flixel::FlxSprite fh = this->_bkg;
HXDLIN( 162)			fh->set_x((fh->x + xx));
HXLINE( 163)			 ::flixel::addons::ui::FlxUIText fh1 = this->_titleText;
HXDLIN( 163)			fh1->set_x((fh1->x + xx));
HXLINE( 164)			 ::flixel::addons::ui::FlxUIText fh2 = this->_bodyText;
HXDLIN( 164)			fh2->set_x((fh2->x + xx));
...
HXLINE( 170)			 ::flixel::FlxSprite fh = this->_bkg;
HXDLIN( 170)			fh->set_y((fh->y + yy));
HXLINE( 171)			 ::flixel::addons::ui::FlxUIText fh1 = this->_titleText;
HXDLIN( 171)			fh1->set_y((fh1->y + yy));
HXLINE( 172)			 ::flixel::addons::ui::FlxUIText fh2 = this->_bodyText;
HXDLIN( 172)			fh2->set_y((fh2->y + yy));
HXLINE( 173)			this->_arrow->set_y(( (Float)(0) ));
            		}
HXLINE( 176)		bool _hx_tmp1;
HXDLIN( 176)		if ((this->_titleText->text != HX_("",00,00,00,00))) {
HXLINE( 176)			_hx_tmp1 = (this->_bodyText->text == HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 183)			 ::flixel::addons::ui::FlxUIText fh = this->_titleText;
HXDLIN( 183)			fh->set_y((fh->y + titleOnlyOffset));
            		}
HXLINE( 187)		 ::flixel::addons::ui::FlxUIText fh2 = this->_titleText;
HXDLIN( 187)		fh2->set_x(( (Float)((fh2->x + this->style->__Field(HX_("leftPadding",8a,98,10,d0),::hx::paccDynamic))) ));
HXLINE( 188)		 ::flixel::addons::ui::FlxUIText fh3 = this->_bodyText;
HXDLIN( 188)		fh3->set_x(( (Float)((fh3->x + this->style->__Field(HX_("leftPadding",8a,98,10,d0),::hx::paccDynamic))) ));
HXLINE( 190)		 ::flixel::addons::ui::FlxUIText fh4 = this->_titleText;
HXDLIN( 190)		fh4->set_y(( (Float)((fh4->y + this->style->__Field(HX_("topPadding",bc,47,4b,3c),::hx::paccDynamic))) ));
HXLINE( 191)		 ::flixel::addons::ui::FlxUIText fh5 = this->_bodyText;
HXDLIN( 191)		fh5->set_y(( (Float)((fh5->y + this->style->__Field(HX_("topPadding",bc,47,4b,3c),::hx::paccDynamic))) ));
...
HXLINE( 214)		 ::flixel::FlxSprite _hx_tmp2 = this->_arrowBkg;
HXDLIN( 214)		_hx_tmp2->set_x(( (Float)(::Std_obj::_hx_int((this->_arrow->x - ( (Float)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) )))) ));
HXLINE( 215)		 ::flixel::FlxSprite _hx_tmp3 = this->_arrowBkg;
HXDLIN( 215)		_hx_tmp3->set_y(( (Float)(::Std_obj::_hx_int((this->_arrow->y - ( (Float)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) )))) ));
HXLINE( 217)		 ::flixel::addons::ui::FlxUIText _hx_tmp4 = this->_titleText;
HXDLIN( 217)		_hx_tmp4->set_x(( (Float)(::Std_obj::_hx_int(this->_titleText->x)) ));
HXLINE( 218)		 ::flixel::addons::ui::FlxUIText _hx_tmp5 = this->_bodyText;
HXDLIN( 218)		_hx_tmp5->set_x(( (Float)(::Std_obj::_hx_int(this->_bodyText->x)) ));
HXLINE( 219)		 ::flixel::FlxSprite _hx_tmp6 = this->_bkg;
HXDLIN( 219)		_hx_tmp6->set_x(( (Float)(::Std_obj::_hx_int(this->_bkg->x)) ));
HXLINE( 220)		 ::flixel::FlxSprite _hx_tmp7 = this->_bkg;
HXDLIN( 220)		_hx_tmp7->set_y(( (Float)(::Std_obj::_hx_int(this->_bkg->y)) ));
HXLINE( 221)		 ::flixel::FlxSprite _hx_tmp8 = this->_arrowBkg;
HXDLIN( 221)		_hx_tmp8->set_x(( (Float)(::Std_obj::_hx_int(this->_arrowBkg->x)) ));
HXLINE( 222)		 ::flixel::FlxSprite _hx_tmp9 = this->_arrowBkg;
HXDLIN( 222)		_hx_tmp9->set_y(( (Float)(::Std_obj::_hx_int(this->_arrowBkg->y)) ));
HXLINE( 223)		 ::flixel::FlxSprite _hx_tmp10 = this->_arrow;
HXDLIN( 223)		_hx_tmp10->set_x(( (Float)(::Std_obj::_hx_int(this->_arrow->x)) ));
HXLINE( 224)		 ::flixel::FlxSprite _hx_tmp11 = this->_arrow;
HXDLIN( 224)		_hx_tmp11->set_y(( (Float)(::Std_obj::_hx_int(this->_arrow->y)) ));
            	}
...
HXLINE( 495)					 ::flixel::addons::ui::AnchorPoint fh = result->x;
HXDLIN( 495)					fh->offset = (fh->offset - ( (Float)(off) ));
...
HXLINE( 500)					 ::flixel::addons::ui::AnchorPoint fh = result->x;
HXDLIN( 500)					fh->offset = (fh->offset + off);
...
HXLINE( 509)					 ::flixel::addons::ui::AnchorPoint fh = result->y;
HXDLIN( 509)					fh->offset = (fh->offset - ( (Float)(off) ));
...
HXLINE( 514)					 ::flixel::addons::ui::AnchorPoint fh = result->y;
HXDLIN( 514)					fh->offset = (fh->offset + off);
...
HXLINE( 526)					 ::flixel::addons::ui::AnchorPoint fh = result->x;
HXDLIN( 526)					fh->offset = (fh->offset + off);
            				}
HXLINE( 528)				if ((result->x->flush == HX_("right",dc,0b,64,e9))) {
HXLINE( 530)					 ::flixel::addons::ui::AnchorPoint fh = result->x;
HXDLIN( 530)					fh->offset = (fh->offset - ( (Float)(off) ));
            				}
            			}
HXLINE( 533)			if (matchVert) {
HXLINE( 535)				if ((result->y->flush == HX_("top",95,66,58,00))) {
HXLINE( 537)					 ::flixel::addons::ui::AnchorPoint fh = result->y;
HXDLIN( 537)					fh->offset = (fh->offset + off);
            				}
HXLINE( 539)				if ((result->y->flush == HX_("bottom",eb,e6,78,65))) {
HXLINE( 541)					 ::flixel::addons::ui::AnchorPoint fh = result->y;
HXDLIN( 541)					fh->offset = (fh->offset - ( (Float)(off) ));
            				}
            			}
            		}
