...
HXLINE( 533)		 ::flixel::math::FlxPoint fh = this->button->offset;
HXDLIN( 533)		fh->set_x((fh->x - ( (Float)((Width - this->button->frameWidth)) )));
HXLINE( 534)		this->button->set_x(this->offset->x);
HXLINE( 535)		 ::flixel::math::FlxPoint fh1 = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 535)		fh1->set_x((fh1->x + this->button->offset->x));
