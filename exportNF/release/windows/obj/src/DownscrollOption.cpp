...
HX_DEFINE_STACK_FRAME(_hx_pos_524d86a494ed656f_106_new,"DownscrollOption","new",0xc6fce9d6,"DownscrollOption.new","Options.hx",106,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_524d86a494ed656f_112_press,"DownscrollOption","press",0x5ec33679,"DownscrollOption.press","Options.hx",112,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_524d86a494ed656f_120_updateDisplay,"DownscrollOption","updateDisplay",0xb9a0582f,"DownscrollOption.updateDisplay","Options.hx",120,0x9d9a0240)

void DownscrollOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_106_new)
HXLINE( 107)		super::__construct();
HXLINE( 108)		this->description = desc;
            	}
...
bool DownscrollOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_112_press)
HXLINE( 113)		::flixel::FlxG_obj::save->data->__SetField(HX_("downscroll",ef,45,d4,4f),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 114)		this->display = this->updateDisplay();
HXLINE( 115)		return true;
            	}


::String DownscrollOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_120_updateDisplay)
HXDLIN( 120)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXDLIN( 120)			return HX_("Downscroll",0f,4a,85,46);
            		}
            		else {
HXDLIN( 120)			return HX_("Upscroll",c8,b0,88,76);
            		}
