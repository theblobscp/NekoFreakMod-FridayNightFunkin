...
HX_DEFINE_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_127_new,"GhostTapOption","new",0x6c686a7b,"GhostTapOption.new","Options.hx",127,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_133_press,"GhostTapOption","press",0xd68bea5e,"GhostTapOption.press","Options.hx",133,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_141_updateDisplay,"GhostTapOption","updateDisplay",0xb7c6f914,"GhostTapOption.updateDisplay","Options.hx",141,0x9d9a0240)

void GhostTapOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_127_new)
HXLINE( 128)		super::__construct();
HXLINE( 129)		this->description = desc;
            	}
...
bool GhostTapOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_133_press)
HXLINE( 134)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghost",4f,8f,58,93),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 135)		this->display = this->updateDisplay();
HXLINE( 136)		return true;
            	}


::String GhostTapOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_141_updateDisplay)
HXDLIN( 141)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )) {
HXDLIN( 141)			return HX_("Ghost Tapping",44,6c,9f,40);
            		}
            		else {
HXDLIN( 141)			return HX_("No Ghost Tapping",45,a4,10,e0);
            		}
