...
HXLINE(  82)		{
HXLINE(  82)			::String v9 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  82)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v9);
            		}
...
HXLINE(  87)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  88)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  89)		if (::hx::IsNotNull( library )) {
HXLINE(  89)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  90)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
HXLINE(  91)		library = ::lime::utils::Assets_obj::getLibrary(HX_("tutorial",9e,8f,b5,82));
HXLINE(  92)		if (::hx::IsNotNull( library )) {
HXLINE(  92)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  93)			::ManifestResources_obj::preloadLibraryNames->push(HX_("tutorial",9e,8f,b5,82));
            		}
HXLINE(  94)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week1",bd,95,be,c7));
HXLINE(  95)		if (::hx::IsNotNull( library )) {
HXLINE(  95)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  96)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week1",bd,95,be,c7));
            		}
HXLINE(  97)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week2",be,95,be,c7));
HXLINE(  98)		if (::hx::IsNotNull( library )) {
HXLINE(  98)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  99)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week2",be,95,be,c7));
            		}
HXLINE( 100)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week3",bf,95,be,c7));
HXLINE( 101)		if (::hx::IsNotNull( library )) {
HXLINE( 101)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 102)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week3",bf,95,be,c7));
            		}
HXLINE( 103)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week4",c0,95,be,c7));
HXLINE( 104)		if (::hx::IsNotNull( library )) {
HXLINE( 104)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 105)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week4",c0,95,be,c7));
            		}
HXLINE( 106)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week5",c1,95,be,c7));
HXLINE( 107)		if (::hx::IsNotNull( library )) {
HXLINE( 107)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 108)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week5",c1,95,be,c7));
            		}
HXLINE( 109)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE( 110)		if (::hx::IsNotNull( library )) {
HXLINE( 110)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 111)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
HXLINE( 112)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 113)		if (::hx::IsNotNull( library )) {
HXLINE( 113)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 114)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
