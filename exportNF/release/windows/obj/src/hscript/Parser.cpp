...
HXLINE( 151)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            		}
            	}
...
HXDLIN( 156)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::EInvalidChar(c)));
            		}
            	}
...
HXLINE( 198)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            			}
            		}
...
HXLINE( 277)		switch((int)(e->_hx_getIndex())){
            			case (int)2: {
HXLINE( 280)				::String _g = e->_hx_getString(0);
HXDLIN( 280)				 ::hscript::CType t = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 280)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 280)						return false;
            			...
            			break;
            			case (int)4: {
HXLINE( 278)				::Array< ::Dynamic> _g = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 278)				return true;
            			}
            			break;
            			case (int)6: {
HXLINE( 282)				::String _g = e->_hx_getString(0);
HXDLIN( 282)				 ::hscript::Expr _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				return this->isBlock(e1);
            			}
            			break;
            			case (int)7: {
HXLINE( 283)				::String _g = e->_hx_getString(0);
HXDLIN( 283)				bool prefix = e->_hx_getBool(1);
...
HXDLIN( 281)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 281)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 284)				return this->isBlock(e1);
            			}
            			break;
            			case (int)11: {
HXLINE( 286)				::String _g = e->_hx_getString(0);
HXDLIN( 286)				 ::hscript::Expr _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 286)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 286)				return this->isBlock(e1);
            			}
            			break;
            			case (int)14: {
HXLINE( 279)				::Array< ::Dynamic> _g = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 279)				::String _g1 = e->_hx_getString(2);
HXDLIN( 279)				 ::hscript::CType _g2 = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 279)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 279)				return this->isBlock(e1);
            			}
            			break;
            			case (int)15: {
HXLINE( 287)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 287)				if (::hx::IsNotNull( e1 )) {
HXLINE( 287)					return this->isBlock(e1);
            				}
            				else {
...
HXDLIN( 288)				::String _g1 = e->_hx_getString(1);
HXDLIN( 288)				 ::hscript::CType _g2 = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 288)				 ::hscript::Expr e1 = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 278)				return true;
            			...
            			break;
            			case (int)23: {
HXLINE( 278)				 ::hscript::Expr _g = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 278)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 278)				 ::hscript::Expr _g2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 278)				return true;
            			}
            			break;
            			case (int)24: {
HXLINE( 285)				 ::hscript::Expr _g = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				return this->isBlock(e1);
            			}
            			break;
            			case (int)25: {
HXLINE( 289)				::String _g = e->_hx_getString(0);
HXDLIN( 289)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 300)				if ((e->_hx_getIndex() == 2)) {
HXLINE( 300)					::String _g = e->_hx_getString(0);
HXDLIN( 300)					 ::hscript::CType _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 300)					 ::hscript::Expr _g2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 442)						 ::hscript::Expr e = this->parseExpr();
HXLINE( 443)						if (::hx::IsNull( e )) {
HXLINE( 444)							return this->makeUnop(op,e);
            						}
HXLINE( 445)						if ((e->_hx_getIndex() == 0)) {
HXLINE( 448)							 ::hscript::Const _g = e->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN( 448)							switch((int)(_g->_hx_getIndex())){
            								case (int)0: {
HXLINE( 446)									int i = _g->_hx_getInt(0);
HXLINE( 447)									return ::hscript::Expr_obj::EConst(::hscript::Const_obj::CInt(-(i)));
            								}
            								break;
            								case (int)1: {
HXLINE( 448)									Float f = _g->_hx_getFloat(0);
...
HXLINE( 370)					 ::hscript::Expr e = this->parseExpr();
HXLINE( 371)					tk = this->token();
HXLINE( 372)					if (::hx::IsNotNull( tk )) {
HXLINE( 372)						switch((int)(tk->_hx_getIndex())){
            							case (int)5: {
HXLINE( 374)								return this->parseExprNext(::hscript::Expr_obj::EParent(e));
            							}
            							break;
            							case (int)9: {
HXLINE( 389)								if ((e->_hx_getIndex() == 1)) {
HXLINE( 390)									::String v = e->_hx_getString(0);
...
HXLINE( 378)									switch((int)(tk->_hx_getIndex())){
            										case (int)5: {
HXLINE( 380)											return this->parseExprNext(::hscript::Expr_obj::ECheckType(e,t));
            										}
            										break;
            										case (int)9: {
HXLINE( 382)											if ((e->_hx_getIndex() == 1)) {
HXLINE( 383)												::String v = e->_hx_getString(0);
...
HXLINE( 428)						 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 428)						_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            					}
            					else {
...
HXDLIN( 415)												_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk2,_this->head);
            											}
HXLINE( 416)											{
HXLINE( 416)												 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 416)												_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            											}
...
HXLINE( 423)										 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 423)										_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            									}
            								}
            								else {
HXLINE( 426)									 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 426)									_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            								}
            							}
            							break;
            							case (int)2: {
...
HXLINE( 403)									{
HXLINE( 403)										 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 403)										_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk2,_this->head);
            									}
HXLINE( 404)									{
HXLINE( 404)										 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 404)										_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            									}
HXLINE( 405)									if (::hx::IsNotNull( tk2 )) {
...
HXLINE( 436)						{
HXLINE( 436)							 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 436)							_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            						}
            					}
            					_hx_goto_36:;
...
HXLINE( 461)						{
HXLINE( 461)							 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 461)							_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            						}
...
HXLINE( 467)						_hx_tmp = ::hx::IsNotNull( a->__get(0).StaticCast<  ::hscript::Expr >() );
            					}
            					else {
HXLINE( 467)						_hx_tmp = false;
            					}
HXDLIN( 467)					if (_hx_tmp) {
HXLINE( 468)						 ::hscript::Expr _g = a->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 468)						switch((int)(_g->_hx_getIndex())){
            							case (int)10: {
HXLINE( 469)								 ::hscript::Expr _g1 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 469)								 ::hscript::Expr _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 470)								::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 471)								 ::hscript::Expr e = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
HXLINE( 476)								return this->parseExprNext(e);
            							}
            							break;
            							case (int)11: {
HXLINE( 469)								::String _g1 = _g->_hx_getString(0);
HXDLIN( 469)								 ::hscript::Expr _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 469)								 ::hscript::Expr _g3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 470)								::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 471)								 ::hscript::Expr e = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
HXLINE( 476)								return this->parseExprNext(e);
            							}
...
HXLINE( 479)					return this->parseExprNext(::hscript::Expr_obj::EArrayDecl(a));
            				}
            				break;
            				case (int)15: {
...
HXLINE( 482)						return ::hscript::Expr_obj::EMeta(id,args,this->parseExpr());
            					}
            					else {
HXLINE( 484)						return this->unexpected(tk);
            					}
...
HXLINE( 517)			{
HXLINE( 517)				 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 517)				_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            			}
...
HXLINE( 543)					 ::hscript::Expr e = _g->__get(0).StaticCast<  ::hscript::Expr >();
HXLINE( 534)					edef = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(1)->init(0,this->mapCompr(tmp,e)));
            				}
            				else {
...
HXDLIN( 541)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 541)				if (::hx::IsNull( e2 )) {
HXLINE( 534)					edef = ::hscript::Expr_obj::EIf(cond,this->mapCompr(tmp,e1),null());
            				}
            				else {
HXLINE( 534)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            				}
            			...
            			break;
            			case (int)10: {
HXLINE( 537)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 537)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				edef = ::hscript::Expr_obj::EWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)11: {
HXLINE( 535)				::String v = e->_hx_getString(0);
HXDLIN( 535)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 535)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)24: {
HXLINE( 539)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 539)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				edef = ::hscript::Expr_obj::EDoWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			default:{
HXLINE( 534)				edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
...
HXLINE( 556)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 557)				::String bop = e->_hx_getString(0);
HXDLIN( 557)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 557)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 558)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 558)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 558)				return ::hscript::Expr_obj::ETernary(this->makeUnop(op,e1),e2,e3);
            			}
            			break;
            			default:{
...
HXLINE( 566)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 567)				::String op2 = e->_hx_getString(0);
HXDLIN( 567)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 567)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 571)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 572)				 ::hscript::Expr e2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 572)				 ::hscript::Expr e3 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 572)				 ::hscript::Expr e4 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 573)				if (this->opRightAssoc->exists(op)) {
HXLINE( 574)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            				}
            				else {
HXLINE( 576)					return ::hscript::Expr_obj::ETernary(this->makeBinop(op,e1,e2),e3,e4);
            				}
            			}
            			break;
            			default:{
...
HXLINE( 640)			 ::hscript::Expr e = this->parseExpr();
HXLINE( 641)			return ::hscript::Expr_obj::EFor(vname,eiter,e);
...
HXLINE( 651)			if (::hx::IsNull( tk )) {
HXLINE( 653)				 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 653)				_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            			}
            			else {
...
HXLINE( 591)			 ::hscript::Expr e1 = this->parseExpr();
...
HXLINE( 602)				{
HXLINE( 602)					 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 602)					_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            				}
HXLINE( 603)				if (semic) {
HXLINE( 603)					 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 603)					_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,::hscript::Token_obj::TSemicolon_dyn(),_this->head);
            				}
            			}
HXLINE( 605)			return ::hscript::Expr_obj::EIf(cond,e1,e2);
...
HXLINE( 659)			{
HXLINE( 659)				 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 659)				_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            			}
HXLINE( 660)			 ::hscript::Expr e;
...
HXLINE( 661)			return ::hscript::Expr_obj::EReturn(e);
HXLINE( 657)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("switch",f4,49,79,c5)) ){
HXLINE( 697)			 ::hscript::Expr e = this->parseExpr();
...
HXLINE( 723)									{
HXLINE( 723)										 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 723)										_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            									}
HXLINE( 724)									if (::hx::IsNull( tk )) {
...
HXLINE( 745)									{
HXLINE( 745)										 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 745)										_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            									}
HXLINE( 746)									if (::hx::IsNull( tk )) {
...
HXLINE( 756)									def = exprs->__get(0).StaticCast<  ::hscript::Expr >();
            								}
            								else {
...
HXLINE( 760)										def = ::hscript::Expr_obj::EBlock(exprs);
            									}
            								}
...
HXLINE( 765)							goto _hx_goto_48;
            			...
            			_hx_goto_48:;
HXLINE( 768)			return ::hscript::Expr_obj::ESwitch(e,cases,def);
HXLINE( 696)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("throw",26,5d,90,0f)) ){
HXLINE( 680)			 ::hscript::Expr e = this->parseExpr();
HXLINE( 681)			return ::hscript::Expr_obj::EThrow(e);
HXLINE( 679)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("try",3b,69,58,00)) ){
HXLINE( 683)			 ::hscript::Expr e = this->parseExpr();
HXLINE( 684)			{
...
HXLINE( 695)			return ::hscript::Expr_obj::ETry(e,vname,t3,ec);
...
HXLINE( 614)			 ::hscript::Expr e = null();
HXLINE( 615)			if (__hxcpp_enum_eq(tk,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
HXLINE( 616)				e = this->parseExpr();
            			}
            			else {
HXLINE( 618)				 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 618)				_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            			}
HXLINE( 619)			return ::hscript::Expr_obj::EVar(ident,t,e);
HXLINE( 606)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("while",b1,43,bd,c9)) ){
HXLINE( 621)			 ::hscript::Expr econd = this->parseExpr();
HXLINE( 622)			 ::hscript::Expr e = this->parseExpr();
HXLINE( 623)			return ::hscript::Expr_obj::EWhile(econd,e);
...
HXLINE( 784)									return ::hscript::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
            							...
            							break;
            							case (int)26: {
HXLINE( 785)								 ::hscript::Expr _hx_tmp = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 786)									 ::hscript::Expr eret = this->parseExpr();
...
HXLINE( 795)							{
HXLINE( 795)								 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 795)								_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            							}
...
HXLINE( 809)					return this->parseExprNext(::hscript::Expr_obj::EArray(e1,e2));
            				...
            				break;
            				case (int)13: {
HXLINE( 811)					 ::hscript::Expr e2 = this->parseExpr();
HXLINE( 812)					{
...
HXLINE( 814)					return ::hscript::Expr_obj::ETernary(e1,e2,e3);
            				}
            				break;
            				default:{
HXLINE( 816)					{
...
HXDLIN( 925)						_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this->head);
            					}
            					else {
...
HXLINE( 913)														{
HXLINE( 913)															 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 913)															 ::hscript::Token item = ::hscript::Token_obj::TOp(op.substr(1,null()));
HXDLIN( 913)															_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,item,_this->head);
            														}
...
HXLINE( 923)								 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 923)								_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this->head);
            							}
            						}
            						else {
HXLINE( 925)							 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
...
HXLINE( 932)					{
HXLINE( 932)						 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 932)						_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,b,_this->head);
            					}
HXLINE( 933)					{
HXLINE( 933)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 933)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,a,_this1->head);
            					}
...
HXLINE( 948)												{
HXLINE( 948)													 ::hscript::Expr _g3 = arg->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 949)													if (::hx::IsNotNull( _g3 )) {
HXLINE( 950)														 ::hscript::Expr v = _g3;
HXLINE( 951)														if (!(this->resumeErrors)) {
HXLINE( 951)															HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6))));
            														}
            													}
            												}
...
HXLINE(1017)					{
HXLINE(1017)						 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN(1017)						_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            					}
...
HXLINE(1089)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::EInvalidOp(HX_("Unsupported class type parameters",9d,ae,a3,50))));
            			}
            		}
...
HXLINE(1119)					{
HXLINE(1119)						 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN(1119)						_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this->head);
            					}
HXLINE(1120)					goto _hx_goto_86;
            				}
HXLINE(1122)				t = this->token();
HXLINE(1123)				if (::hx::IsNull( t )) {
...
HXLINE(1277)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::EUnterminatedString_dyn()));
            				}
...
HXLINE(1304)												HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::EUnterminatedString_dyn()));
            											}
            										}
...
HXLINE(1398)										{
HXLINE(1398)											 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN(1398)											_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,::hscript::Token_obj::TOp(HX_("...",ee,0f,23,00)),_this->head);
            										}
...
HXLINE(1386)													 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN(1386)													_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this->head);
            												}
            												else {
...
HXLINE(1593)					 ::hscript::Expr e1 = _g;
...
HXLINE(1595)					 ::hscript::Expr e1 = _g;
HXDLIN(1595)					 ::hscript::Expr e2 = _g1;
...
HXLINE(1598)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            						}
            					}
HXLINE(1599)					return false;
            			...
            			break;
            			case (int)7: {
HXLINE(1589)				bool _g = e->_hx_getBool(1);
HXDLIN(1589)				if ((e->_hx_getString(0) == HX_("!",21,00,00,00))) {
HXLINE(1589)					 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE(1590)					return !(this->evalPreproCond(e1));
            				}
            				else {
HXLINE(1598)					{
HXLINE(1598)						 ::hscript::Error err = ::hscript::Error_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e)));
...
HXLINE(1643)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::EInvalidPreprocessor(HX_("Unclosed",e5,94,4a,ea))));
            				}
            			}
...
HXLINE(1674)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::EUnterminatedComment_dyn()));
            						}
...
HXLINE(1681)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::Error_obj::EUnterminatedComment_dyn()));
            					}
HXLINE(1682)					goto _hx_goto_113;
            				}
HXLINE(1684)				if ((_hx_char == 47)) {
HXLINE(1685)					goto _hx_goto_113;
            				}
            			}
            			_hx_goto_113:;
