...
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_588_doWhileLoop,"hscript.Interp","doWhileLoop",0x813d4b4b,"hscript.Interp.doWhileLoop","hscript/Interp.hx",588,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_605_whileLoop,"hscript.Interp","whileLoop",0xce1b3216,"hscript.Interp.whileLoop","hscript/Interp.hx",605,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_621_makeIterator,"hscript.Interp","makeIterator",0x634d013b,"hscript.Interp.makeIterator","hscript/Interp.hx",621,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_631_forLoop,"hscript.Interp","forLoop",0xdf1ff72e,"hscript.Interp.forLoop","hscript/Interp.hx",631,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_651_isMap,"hscript.Interp","isMap",0x34ae9fb3,"hscript.Interp.isMap","hscript/Interp.hx",651,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_655_getMapValue,"hscript.Interp","getMapValue",0x1594fb8c,"hscript.Interp.getMapValue","hscript/Interp.hx",655,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_659_setMapValue,"hscript.Interp","setMapValue",0x20020298,"hscript.Interp.setMapValue","hscript/Interp.hx",659,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_662_get,"hscript.Interp","get",0xf7e1c137,"hscript.Interp.get","hscript/Interp.hx",662,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_678_set,"hscript.Interp","set",0xf7eadc43,"hscript.Interp.set","hscript/Interp.hx",678,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_685_fcall,"hscript.Interp","fcall",0x6ff6aee5,"hscript.Interp.fcall","hscript/Interp.hx",685,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_689_call,"hscript.Interp","call",0xeaff64dd,"hscript.Interp.call","hscript/Interp.hx",689,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_692_cnew,"hscript.Interp","cnew",0xeb093c1c,"hscript.Interp.cnew","hscript/Interp.hx",692,0xf078416e)
namespace hscript{
...
HXLINE( 443)					if (_gthis->inTry) {
HXLINE( 444)						try {
            							HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 445)							r = me->exprReturn(fexpr);
            						} catch( ::Dynamic _hx_e) {
            							if (_hx_e.IsClass<  ::Dynamic >() ){
            								HX_STACK_BEGIN_CATCH
            								 ::Dynamic _g = _hx_e;
...
HXLINE( 447)								me->locals = old;
HXLINE( 448)								me->depth = depth;
HXLINE( 452)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            							}
            							else {
            								HX_STACK_DO_THROW(_hx_e);
            							}
...
HXLINE( 456)						r = me->exprReturn(fexpr);
            					}
HXLINE( 457)					me->locals = old;
HXLINE( 458)					me->depth = depth;
HXLINE( 459)					return r;
            				}
...
HXLINE( 461)				 ::Dynamic f1 = ::Reflect_obj::makeVarArgs(f);
HXLINE( 462)				if (::hx::IsNotNull( name )) {
HXLINE( 463)					if ((this->depth == 0)) {
HXLINE( 465)						this->variables->set(name,f1);
            					}
            					else {
HXLINE( 468)						::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 468)						::String name1 = name;
HXDLIN( 468)						_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(2)
            							->setFixed(0,HX_("n",6e,00,00,00),name1)
            							->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(name))));
HXLINE( 469)						 ::Dynamic ref =  ::Dynamic(::hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("r",72,00,00,00),f1));
HXLINE( 470)						this->locals->set(name,ref);
HXLINE( 471)						capturedLocals->set(name,ref);
            					}
            				}
HXLINE( 474)				return f1;
            			}
            			break;
            			case (int)15: {
...
HXLINE( 405)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 517)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 517)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 518)				 ::Dynamic arr = this->expr(e1);
HXLINE( 519)				 ::Dynamic index1 = this->expr(index);
HXLINE( 520)				if (::Std_obj::isOfType(arr,::hx::ClassOf< ::haxe::IMap >())) {
HXLINE( 521)					return ::haxe::IMap_obj::get( ::hx::interface_check(arr,0x09c2bd39),index1);
            				}
            				else {
HXLINE( 524)					return arr->__GetItem(( (int)(index1) ));
            				}
            			}
            			break;
            			case (int)17: {
HXLINE( 475)				::Array< ::Dynamic> arr = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 476)				bool _hx_tmp;
HXDLIN( 476)				if ((arr->length > 0)) {
HXLINE( 476)					 ::hscript::Expr _g = arr->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 476)					if ((_g->_hx_getIndex() == 6)) {
HXLINE( 476)						 ::hscript::Expr _g1 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 476)						 ::hscript::Expr _g2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 476)						if ((_g->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXLINE( 477)					bool isAllString = true;
HXLINE( 478)					bool isAllInt = true;
HXLINE( 479)					bool isAllObject = true;
HXLINE( 480)					bool isAllEnum = true;
HXLINE( 481)					::cpp::VirtualArray keys = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 482)					::cpp::VirtualArray values = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 483)					{
HXLINE( 483)						int _g = 0;
HXDLIN( 483)						while((_g < arr->length)){
HXLINE( 483)							 ::hscript::Expr e = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 483)							_g = (_g + 1);
HXLINE( 484)							if ((e->_hx_getIndex() == 6)) {
HXLINE( 485)								if ((e->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 485)									 ::hscript::Expr eKey = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 485)									 ::hscript::Expr eValue = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 485)									{
HXLINE( 486)										 ::Dynamic key = this->expr(eKey);
HXLINE( 487)										 ::Dynamic value = this->expr(eValue);
HXLINE( 488)										if (isAllString) {
HXLINE( 488)											isAllString = ::Std_obj::isOfType(key,::hx::ClassOf< ::String >());
            										}
            										else {
HXLINE( 488)											isAllString = false;
            										}
HXLINE( 489)										if (isAllInt) {
HXLINE( 489)											isAllInt = ::Std_obj::isOfType(key,::hx::ClassOf< int >());
            										}
            										else {
HXLINE( 489)											isAllInt = false;
            										}
HXLINE( 490)										if (isAllObject) {
HXLINE( 490)											isAllObject = ::Reflect_obj::isObject(key);
            										}
            										else {
HXLINE( 490)											isAllObject = false;
            										}
HXLINE( 491)										if (isAllEnum) {
HXLINE( 491)											isAllEnum = ::Reflect_obj::isEnumValue(key);
            										}
            										else {
HXLINE( 491)											isAllEnum = false;
            										}
HXLINE( 492)										keys->push(key);
HXLINE( 493)										values->push(value);
            									}
            								}
            								else {
HXLINE( 495)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("=> expected",17,e5,65,e5)));
            								}
            							}
            							else {
HXLINE( 495)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("=> expected",17,e5,65,e5)));
...
HXLINE( 498)					 ::Dynamic map;
HXLINE( 499)					if (isAllInt) {
HXLINE( 498)						map =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            					}
            					else {
HXLINE( 500)						if (isAllString) {
HXLINE( 498)							map =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            						}
            						else {
HXLINE( 501)							if (isAllEnum) {
HXLINE( 498)								map =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
            							}
            							else {
HXLINE( 502)								if (isAllObject) {
HXLINE( 498)									map =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            								}
            								else {
HXLINE( 503)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Inconsistent key types",af,4f,50,a9)));
            								}
            							}
            						}
            					}
HXLINE( 505)					{
HXLINE( 505)						int _g1 = 0;
HXDLIN( 505)						int _g2 = keys->get_length();
HXDLIN( 505)						while((_g1 < _g2)){
HXLINE( 505)							_g1 = (_g1 + 1);
HXDLIN( 505)							int n = (_g1 - 1);
HXLINE( 506)							::haxe::IMap_obj::set( ::hx::interface_check(map,0x09c2bd39),keys->__get(n),values->__get(n));
            						}
            					}
HXLINE( 508)					return map;
            				}
            				else {
HXLINE( 511)					::cpp::VirtualArray a = ::cpp::VirtualArray_obj::__new();
HXLINE( 512)					{
HXLINE( 512)						int _g = 0;
HXDLIN( 512)						while((_g < arr->length)){
HXLINE( 512)							 ::hscript::Expr e = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 512)							_g = (_g + 1);
HXLINE( 513)							a->push(this->expr(e));
            						}
            					}
HXLINE( 515)					return a;
            				}
            			...
            			break;
            			case (int)18: {
HXLINE( 526)				::String cl = e->_hx_getString(0);
HXDLIN( 526)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 527)				::cpp::VirtualArray a = ::cpp::VirtualArray_obj::__new();
HXLINE( 528)				{
HXLINE( 528)					int _g = 0;
HXDLIN( 528)					while((_g < params->length)){
HXLINE( 528)						 ::hscript::Expr e = params->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)						_g = (_g + 1);
HXLINE( 529)						a->push(this->expr(e));
            					}
            				}
HXLINE( 530)				return this->cnew(cl,a);
            			}
            			break;
            			case (int)19: {
HXLINE( 531)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 532)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(this->expr(e1)));
            			}
            			break;
            			case (int)20: {
HXLINE( 533)				 ::hscript::CType _g = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 533)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 533)				::String n = e->_hx_getString(1);
HXDLIN( 533)				 ::hscript::Expr ecatch = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				int old = this->declared->length;
HXLINE( 535)				bool oldTry = this->inTry;
HXLINE( 536)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 537)					this->inTry = true;
HXLINE( 538)					 ::Dynamic v = this->expr(e1);
HXLINE( 539)					this->restore(old);
HXLINE( 540)					this->inTry = oldTry;
HXLINE( 541)					return v;
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
...
HXDLIN(   1)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 536)						if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)							 ::hscript::_Interp::Stop err = _g1;
HXLINE( 543)							this->inTry = oldTry;
HXLINE( 544)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            						}
            						else {
HXLINE(   1)							 ::Dynamic err = _g1;
HXLINE( 547)							this->restore(old);
HXLINE( 548)							this->inTry = oldTry;
HXLINE( 550)							::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 550)							_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(2)
            								->setFixed(0,HX_("n",6e,00,00,00),n)
            								->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n))));
HXLINE( 551)							this->locals->set(n, ::Dynamic(::hx::Anon_obj::Create(1)
            								->setFixed(0,HX_("r",72,00,00,00),err)));
HXLINE( 552)							 ::Dynamic v = this->expr(ecatch);
...
HXLINE( 554)							return v;
            			...
            			break;
            			case (int)21: {
HXLINE( 556)				::Array< ::Dynamic> fl = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 557)				 ::Dynamic o =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 558)				{
HXLINE( 558)					int _g = 0;
HXDLIN( 558)					while((_g < fl->length)){
HXLINE( 558)						 ::Dynamic f = fl->__get(_g);
HXDLIN( 558)						_g = (_g + 1);
HXLINE( 559)						::String f1 = ( (::String)(f->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
HXDLIN( 559)						this->set(o,f1,this->expr(f->__Field(HX_("e",65,00,00,00),::hx::paccDynamic)));
            					}
            				}
HXLINE( 560)				return o;
            			}
            			break;
            			case (int)22: {
HXLINE( 561)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 562)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 562)					return this->expr(e1);
            				}
            				else {
HXLINE( 562)					return this->expr(e2);
            				}
            			}
            			break;
            			case (int)23: {
HXLINE( 563)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 563)				::Array< ::Dynamic> cases = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 563)				 ::hscript::Expr def = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 564)				 ::Dynamic val = this->expr(e1);
HXLINE( 565)				bool match = false;
HXLINE( 566)				{
HXLINE( 566)					int _g = 0;
HXDLIN( 566)					while((_g < cases->length)){
HXLINE( 566)						 ::Dynamic c = cases->__get(_g);
HXDLIN( 566)						_g = (_g + 1);
HXLINE( 567)						{
HXLINE( 567)							int _g1 = 0;
HXDLIN( 567)							::Array< ::Dynamic> _g2 = ( (::Array< ::Dynamic>)(c->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) );
HXDLIN( 567)							while((_g1 < _g2->length)){
HXLINE( 567)								 ::hscript::Expr v = _g2->__get(_g1).StaticCast<  ::hscript::Expr >();
HXDLIN( 567)								_g1 = (_g1 + 1);
HXLINE( 568)								if (::hx::IsEq( this->expr(v),val )) {
HXLINE( 569)									match = true;
HXLINE( 570)									goto _hx_goto_63;
            								}
            							}
            							_hx_goto_63:;
            						}
HXLINE( 572)						if (match) {
HXLINE( 573)							val = this->expr(c->__Field(HX_("expr",35,fd,1d,43),::hx::paccDynamic));
HXLINE( 574)							goto _hx_goto_62;
            						}
            					}
            					_hx_goto_62:;
            				}
HXLINE( 577)				if (!(match)) {
HXLINE( 578)					if (::hx::IsNull( def )) {
HXLINE( 578)						val = null();
            					}
            					else {
HXLINE( 578)						val = this->expr(def);
            					}
            				}
...
HXLINE( 395)				return null();
            			...
            			break;
            			case (int)25: {
HXLINE( 580)				::String _g = e->_hx_getString(0);
HXDLIN( 580)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 580)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 581)				return this->expr(e1);
            			}
            			break;
            			case (int)26: {
HXLINE( 582)				 ::hscript::CType _g = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 582)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
void Interp_obj::doWhileLoop( ::hscript::Expr econd, ::hscript::Expr e){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_588_doWhileLoop)
HXLINE( 589)		int old = this->declared->length;
HXLINE( 590)		while(true){
HXLINE( 591)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 592)				this->expr(e);
            			} catch( ::Dynamic _hx_e) {
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
...
HXDLIN(   1)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 591)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)						 ::hscript::_Interp::Stop err = _g1;
HXLINE( 594)						switch((int)(err->_hx_getIndex())){
            							case (int)0: {
HXLINE( 596)								goto _hx_goto_67;
            							}
            							break;
            							case (int)1: {
            							}
            							break;
            							case (int)2: {
HXLINE( 597)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            							}
            							break;
            						}
            					}
            					else {
HXLINE( 591)						HX_STACK_DO_THROW(_g);
            					}
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 590)			if (!(::hx::IsEq( this->expr(econd),true ))) {
HXLINE( 590)				goto _hx_goto_67;
            			}
            		}
            		_hx_goto_67:;
HXLINE( 602)		this->restore(old);
            	}
...
void Interp_obj::whileLoop( ::hscript::Expr econd, ::hscript::Expr e){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_605_whileLoop)
HXLINE( 606)		int old = this->declared->length;
HXLINE( 607)		while(::hx::IsEq( this->expr(econd),true )){
HXLINE( 608)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 609)				this->expr(e);
            			} catch( ::Dynamic _hx_e) {
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
...
HXDLIN(   1)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 608)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)						 ::hscript::_Interp::Stop err = _g1;
HXLINE( 611)						switch((int)(err->_hx_getIndex())){
            							case (int)0: {
HXLINE( 613)								goto _hx_goto_69;
            							}
            							break;
            							case (int)1: {
            							}
            							break;
            							case (int)2: {
HXLINE( 614)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            							}
            							break;
            						}
            					}
            					else {
HXLINE( 608)						HX_STACK_DO_THROW(_g);
            					}
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,whileLoop,(void))
 ...
 ::Dynamic Interp_obj::makeIterator( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_621_makeIterator)
HXLINE( 625)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 625)			v = v->__Field(HX_("iterator",ee,49,9a,93),::hx::paccDynamic)();
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
...
HXDLIN( 627)		if (::hx::IsNotNull( v->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic) )) {
HXLINE( 627)			_hx_tmp = ::hx::IsNull( v->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic) );
            		}
            		else {
HXLINE( 627)			_hx_tmp = true;
            		}
HXDLIN( 627)		if (_hx_tmp) {
HXLINE( 627)			 ::hscript::Error e = ::hscript::Error_obj::EInvalidIterator(v);
HXDLIN( 627)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
HXLINE( 628)		return v;
            	}
...
void Interp_obj::forLoop(::String n, ::hscript::Expr it, ::hscript::Expr e){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_631_forLoop)
HXLINE( 632)		int old = this->declared->length;
HXLINE( 633)		::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 633)		_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("n",6e,00,00,00),n)
            			->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n))));
HXLINE( 634)		 ::Dynamic it1 = this->makeIterator(this->expr(it));
HXLINE( 635)		while(( (bool)(it1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 636)			{
HXLINE( 636)				::Dynamic this1 = this->locals;
HXDLIN( 636)				( ( ::haxe::ds::StringMap)(this1) )->set(n, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("r",72,00,00,00),it1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)())));
            			}
HXLINE( 637)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 638)				this->expr(e);
            			} catch( ::Dynamic _hx_e) {
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
...
HXDLIN(   1)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 637)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)						 ::hscript::_Interp::Stop err = _g1;
HXLINE( 640)						switch((int)(err->_hx_getIndex())){
            							case (int)0: {
HXLINE( 642)								goto _hx_goto_72;
            							}
            							break;
            							case (int)1: {
            							}
            							break;
            							case (int)2: {
HXLINE( 643)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            							}
            							break;
            						}
            					}
            					else {
HXLINE( 637)						HX_STACK_DO_THROW(_g);
            					}
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
...
bool Interp_obj::isMap( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_651_isMap)
HXDLIN( 651)		return ::Std_obj::isOfType(o,::hx::ClassOf< ::haxe::IMap >());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,isMap,return )
 ...
 ::Dynamic Interp_obj::getMapValue( ::Dynamic map, ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_655_getMapValue)
HXDLIN( 655)		return ::haxe::IMap_obj::get( ::hx::interface_check(map,0x09c2bd39),key);
            	}
...
void Interp_obj::setMapValue( ::Dynamic map, ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_659_setMapValue)
HXDLIN( 659)		::haxe::IMap_obj::set( ::hx::interface_check(map,0x09c2bd39),key,value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,setMapValue,(void))
 ...
 ::Dynamic Interp_obj::get( ::Dynamic o,::String f){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_662_get)
HXLINE( 663)		if (::hx::IsNull( o )) {
HXLINE( 663)			 ::hscript::Error e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 663)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
HXLINE( 664)		return ::Reflect_obj::getProperty(o,f);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,get,return )
 ...
 ::Dynamic Interp_obj::set( ::Dynamic o,::String f, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_678_set)
HXLINE( 679)		if (::hx::IsNull( o )) {
HXLINE( 679)			 ::hscript::Error e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 679)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
HXLINE( 680)		::Reflect_obj::setProperty(o,f,v);
HXLINE( 681)		return v;
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,set,return )
 ...
 ::Dynamic Interp_obj::fcall( ::Dynamic o,::String f,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_685_fcall)
HXDLIN( 685)		return this->call(o,this->get(o,f),args);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,fcall,return )
 ...
 ::Dynamic Interp_obj::call( ::Dynamic o, ::Dynamic f,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_689_call)
HXDLIN( 689)		return ::Reflect_obj::callMethod(o,f,args);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,call,return )
 ...
 ::Dynamic Interp_obj::cnew(::String cl,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_692_cnew)
HXLINE( 693)		::hx::Class c = ::Type_obj::resolveClass(cl);
HXLINE( 694)		if (::hx::IsNull( c )) {
HXLINE( 694)			c = this->resolve(cl);
            		}
HXLINE( 695)		return ::Type_obj::createInstance(c,args);
            	}
