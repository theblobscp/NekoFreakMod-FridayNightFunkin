...
HX_DEFINE_STACK_FRAME(_hx_pos_24a6120f5d880dfd_489_new,"WatermarkOption","new",0xd9f8738b,"WatermarkOption.new","Options.hx",489,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_495_press,"WatermarkOption","press",0xcefc576e,"WatermarkOption.press","Options.hx",495,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_504_updateDisplay,"WatermarkOption","updateDisplay",0x9902f624,"WatermarkOption.updateDisplay","Options.hx",504,0x9d9a0240)

void WatermarkOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_489_new)
HXLINE( 490)		super::__construct();
HXLINE( 491)		this->description = desc;
            	}
...
bool WatermarkOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_495_press)
HXLINE( 496)		::Main_obj::watermarks = !(::Main_obj::watermarks);
HXLINE( 497)		::flixel::FlxG_obj::save->data->__SetField(HX_("watermark",a4,af,1e,e0),::Main_obj::watermarks,::hx::paccDynamic);
HXLINE( 498)		this->display = this->updateDisplay();
HXLINE( 499)		return true;
            	}


::String WatermarkOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_504_updateDisplay)
HXDLIN( 504)		::String _hx_tmp;
HXDLIN( 504)		if (::Main_obj::watermarks) {
HXDLIN( 504)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 504)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 504)		return (HX_("Watermarks ",d1,dc,17,0d) + _hx_tmp);
            	}
