...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_346_createCoolText,"TitleState","createCoolText",0x83610287,"TitleState.createCoolText","TitleState.hx",346,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_357_addMoreText,"TitleState","addMoreText",0xcf420fae,"TitleState.addMoreText","TitleState.hx",357,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_367_deleteCoolText,"TitleState","deleteCoolText",0x8afda2b6,"TitleState.deleteCoolText","TitleState.hx",367,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_375_beatHit,"TitleState","beatHit",0xfba69a88,"TitleState.beatHit","TitleState.hx",375,0xd132a6e5)
...
HXLINE( 448)		this->skippedIntro = false;
...
HXDLIN(  64)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_nekofreak/TitleState.hx",fa,c3,dd,75),64,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
...
HXDLIN( 315)					::String s = ::MainMenuState_obj::kadeEngineVer;
HXDLIN( 315)					if ((s.indexOf(::StringTools_obj::trim(data),null()) == -1)) {
HXLINE( 315)						_hx_tmp1 = !(::OutdatedSubState_obj::leftState);
            					}
            					else {
HXLINE( 315)						_hx_tmp1 = false;
            					}
HXDLIN( 315)					if (_hx_tmp1) {
HXLINE( 315)						_hx_tmp = (::MainMenuState_obj::nightly == HX_("",00,00,00,00));
            					}
            					else {
...
HXLINE( 326)					::haxe::Log_obj::trace((HX_("error: ",6e,80,0a,ea) + error),::hx::SourceInfo(HX_("source_nekofreak/TitleState.hx",fa,c3,dd,75),326,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 327)					{
...
HXLINE( 311)				 ::sys::Http http =  ::sys::Http_obj::__alloc( HX_CTX ,HX_("https://raw.githubusercontent.com/KadeDev/Kade-Engine/master/version.downloadMe",75,a0,51,4f));
HXLINE( 313)				http->onData =  ::Dynamic(new _hx_Closure_0());
HXLINE( 325)				http->onError =  ::Dynamic(new _hx_Closure_1());
HXLINE( 330)				http->request(null());
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 336)		if (pressedEnter) {
HXLINE( 336)			_hx_tmp3 = !(this->skippedIntro);
            		}
            		else {
HXLINE( 336)			_hx_tmp3 = false;
            		}
HXDLIN( 336)		if (_hx_tmp3) {
HXLINE( 336)			_hx_tmp2 = ::TitleState_obj::initialized;
            		}
            		else {
HXLINE( 336)			_hx_tmp2 = false;
            		}
HXDLIN( 336)		if (_hx_tmp2) {
HXLINE( 338)			this->skipIntro();
            		}
...
void TitleState_obj::createCoolText(::Array< ::String > textArray){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_346_createCoolText)
HXDLIN( 346)		int _g = 0;
HXDLIN( 346)		int _g1 = textArray->length;
HXDLIN( 346)		while((_g < _g1)){
HXDLIN( 346)			_g = (_g + 1);
HXDLIN( 346)			int i = (_g - 1);
HXLINE( 348)			 ::Alphabet money =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),textArray->__get(i),true,false);
HXLINE( 349)			money->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 350)			money->set_y((money->y + ((i * 60) + 200)));
HXLINE( 351)			this->credGroup->add(money).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 352)			this->textGroup->add(money).StaticCast<  ::flixel::FlxBasic >();
            		}
            	}
...
void TitleState_obj::addMoreText(::String text){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_357_addMoreText)
HXLINE( 358)		 ::Alphabet coolText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),text,true,false);
HXLINE( 359)		coolText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 360)		coolText->set_y((coolText->y + ((this->textGroup->length * 60) + 200)));
HXLINE( 361)		this->credGroup->add(coolText).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 362)		this->textGroup->add(coolText).StaticCast<  ::flixel::FlxBasic >();
            	}
...
void TitleState_obj::deleteCoolText(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_367_deleteCoolText)
HXDLIN( 367)		while((this->textGroup->members->get_length() > 0)){
HXLINE( 369)			this->credGroup->remove(Dynamic( this->textGroup->members->__get(0)).StaticCast<  ::flixel::FlxBasic >(),true).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 370)			this->textGroup->remove(Dynamic( this->textGroup->members->__get(0)).StaticCast<  ::flixel::FlxBasic >(),true).StaticCast<  ::flixel::FlxBasic >();
            		}
            	}
...
void TitleState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_375_beatHit)
HXLINE( 376)		this->super::beatHit();
HXLINE( 378)		this->logoBl->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 379)		this->danceLeft = !(this->danceLeft);
HXLINE( 381)		if (this->danceLeft) {
HXLINE( 382)			this->gfDance->animation->play(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            		}
            		else {
HXLINE( 384)			this->gfDance->animation->play(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            		}
HXLINE( 388)		switch((int)(this->curBeat)){
            			case (int)1: {
HXLINE( 391)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_20,4));
            			}
            			break;
            			case (int)3: {
HXLINE( 394)				this->addMoreText(HX_("present",fb,3a,dc,39));
            			}
            			break;
            			case (int)4: {
HXLINE( 398)				this->deleteCoolText();
            			...
            			break;
            			case (int)5: {
HXLINE( 403)				if (::Main_obj::watermarks) {
HXLINE( 404)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_21,2));
            				}
            				else {
HXLINE( 406)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_22,2));
            				}
            			}
            			break;
            			case (int)7: {
HXLINE( 408)				if (::Main_obj::watermarks) {
HXLINE( 409)					this->addMoreText(HX_("KadeDeveloper",93,41,22,2c));
            				}
            				else {
HXLINE( 412)					this->addMoreText(HX_("Newgrounds",cc,13,58,ed));
HXLINE( 413)					this->ngSpr->set_visible(true);
            				}
            			}
            			break;
            			case (int)8: {
HXLINE( 417)				this->deleteCoolText();
HXLINE( 418)				this->ngSpr->set_visible(false);
            			}
            			break;
            			case (int)9: {
HXLINE( 424)				this->createCoolText(::Array_obj< ::String >::__new(1)->init(0,this->curWacky->__get(0)));
            			}
            			break;
            			case (int)11: {
HXLINE( 427)				this->addMoreText(this->curWacky->__get(1));
            			}
            			break;
            			case (int)12: {
HXLINE( 430)				this->deleteCoolText();
            			...
            			break;
            			case (int)13: {
HXLINE( 435)				this->addMoreText(HX_("Friday",ff,00,5d,e6));
            			}
            			break;
            			case (int)14: {
HXLINE( 438)				this->addMoreText(HX_("Night",b8,29,f7,2e));
            			}
            			break;
            			case (int)15: {
...
void TitleState_obj::skipIntro(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_452_skipIntro)
HXDLIN( 452)		if (!(this->skippedIntro)) {
HXLINE( 454)			this->remove(this->ngSpr,null());
HXLINE( 456)			::flixel::FlxG_obj::camera->flash(-1,4,null(),null());
HXLINE( 457)			this->remove(this->credGroup,null());
HXLINE( 458)			this->skippedIntro = true;
            		}
            	}
