...
HXLINE(  56)		this->animation->addByPrefix(HX_("neko-sweet",7e,72,3b,4d),HX_("neko_outline",9e,7d,44,09),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("neko-sweet",7e,72,3b,4d), ::CharacterSetting_obj::__alloc( HX_CTX ,15,95,((Float)1.4),null()));
HXDLIN(  24)			return _g;
            		}
