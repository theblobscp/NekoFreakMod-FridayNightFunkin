...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_60_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",60,0xf7836789)
...
HXLINE(  40)		this->animation->add(HX_("neko-sweet",7e,72,3b,4d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
HXLINE(  41)		this->animation->add(HX_("neko-crazy",9f,22,81,13),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_24,2),0,false,isPlayer,null());
HXLINE(  42)		this->animation->add(HX_("neko-schizo",38,d4,c3,c4),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_25,2),0,false,isPlayer,null());
HXLINE(  43)		this->animation->add(HX_("neko-bonus",2d,c3,28,7e),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_26,2),0,false,isPlayer,null());
HXLINE(  44)		this->animation->add(HX_("nekunt",27,44,cd,69),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_27,2),0,false,isPlayer,null());
HXLINE(  45)		this->animation->add(HX_("bf-fresh",e5,c3,72,7b),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_28,2),0,false,isPlayer,null());
HXLINE(  46)		this->animation->add(HX_("bf-confused",0a,55,5f,31),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_29,2),0,false,isPlayer,null());
HXLINE(  47)		this->animation->add(HX_("bf-scared",c9,02,f4,15),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_30,2),0,false,isPlayer,null());
HXLINE(  48)		this->animation->play(_hx_char,null(),null(),null());
HXLINE(  50)		::String _hx_switch_0 = _hx_char;
...
HXLINE(  53)			this->set_antialiasing(false);
HXDLIN(  53)			goto _hx_goto_0;
            		}
            		_hx_goto_0:;
HXLINE(  56)		this->scrollFactor->set(null(),null());
            	}
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_60_update)
HXLINE(  61)		this->super::update(elapsed);
HXLINE(  63)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(  64)			Float _hx_tmp = this->sprTracker->x;
HXDLIN(  64)			Float _hx_tmp1 = ((_hx_tmp + this->sprTracker->get_width()) + 10);
HXDLIN(  64)			this->setPosition(_hx_tmp1,(this->sprTracker->y - ( (Float)(30) )));
            		}
            	}
