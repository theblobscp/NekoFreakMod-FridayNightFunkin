...
HXLINE( 573)				if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
void Controls_obj::addGamepad(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_580_addGamepad)
HXLINE( 581)		this->gamepadsAdded->push(id);
HXLINE( 584)		{
HXLINE( 584)			::Dynamic map = buttonMap;
HXDLIN( 584)			::Dynamic _g_map = map;
HXDLIN( 584)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 584)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 584)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 584)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 584)				 ::Control _g1_key = key;
HXDLIN( 584)				 ::Control control = _g1_key;
HXDLIN( 584)				::Array< int > buttons = _g1_value;
HXLINE( 585)				{
...
void Controls_obj::addGamepadLiteral(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_593_addGamepadLiteral)
HXLINE( 594)		this->gamepadsAdded->push(id);
HXLINE( 597)		{
HXLINE( 597)			::Dynamic map = buttonMap;
HXDLIN( 597)			::Dynamic _g_map = map;
HXDLIN( 597)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 597)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 597)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 597)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 597)				 ::Control _g1_key = key;
HXDLIN( 597)				 ::Control control = _g1_key;
HXDLIN( 597)				::Array< int > buttons = _g1_value;
HXLINE( 598)				{
...
HXDLIN( 613)					if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
...
HXDLIN( 624)		{
HXDLIN( 624)			::Dynamic map = _g;
HXDLIN( 624)			::Dynamic _g_map = map;
HXDLIN( 624)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 624)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 624)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 624)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 624)				 ::Control _g1_key = key;
HXDLIN( 624)				 ::Control control = _g1_key;
HXDLIN( 624)				::Array< int > buttons = _g1_value;
HXDLIN( 624)				{
...
HXDLIN( 702)					_g = (_g + 1);
HXLINE( 704)					if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
HXDLIN( 689)			if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
...
HXDLIN( 730)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 732)				return ::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() );
            			}
            			break;
            			case (int)1: {
HXLINE( 733)				int id = device->_hx_getInt(0);
HXDLIN( 733)				if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 733)					if ((id != -1)) {
...
HXDLIN( 739)		if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
