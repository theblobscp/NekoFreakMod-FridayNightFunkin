...
HX_DEFINE_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_468_new,"CustomizeGameplay","new",0xb144179b,"CustomizeGameplay.new","Options.hx",468,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_474_press,"CustomizeGameplay","press",0xcb851f7e,"CustomizeGameplay.press","Options.hx",474,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_482_updateDisplay,"CustomizeGameplay","updateDisplay",0x26aa4e34,"CustomizeGameplay.updateDisplay","Options.hx",482,0x9d9a0240)

void CustomizeGameplay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_468_new)
HXLINE( 469)		super::__construct();
HXLINE( 470)		this->description = desc;
            	}
...
bool CustomizeGameplay_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_474_press)
HXLINE( 475)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source_nekofreak/Options.hx",0b,16,cb,a2),475,HX_("CustomizeGameplay",29,ae,ab,0c),HX_("press",83,53,88,c8)));
HXLINE( 476)		{
HXLINE( 476)			 ::flixel::FlxState nextState =  ::GameplayCustomizeState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 476)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 476)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String CustomizeGameplay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_482_updateDisplay)
HXDLIN( 482)		return HX_("Customize Gameplay",a3,2e,c4,04);
            	}
