...
HXLINE( 659)				currentTextHeight = ( (Float)(::Math_obj::ceil((((group1->offsetY - ( (Float)(2) )) + group1->ascent) + group1->descent))) );
...
HXDLIN( 670)			int heightValue = ::Math_obj::ceil(((ascent + descent) + leading));
HXLINE( 699)			currentLineAscent = ascent;
HXLINE( 700)			currentLineDescent = descent;
HXLINE( 701)			currentLineLeading = leading;
HXLINE( 703)			currentTextHeight = ( (Float)(::Math_obj::ceil((ascent + descent))) );
