...
HXDLIN(2539)					if (::hx::IsNotNull( cursor )) {
HXLINE(2539)						_hx_tmp = ::hx::IsNotNull( this->window );
            					}
            					else {
...
HXDLIN(2547)			if (::hx::IsNull( cursor )) {
HXLINE(2547)				_hx_tmp = ::hx::IsNotNull( this->window );
            			}
            			else {
