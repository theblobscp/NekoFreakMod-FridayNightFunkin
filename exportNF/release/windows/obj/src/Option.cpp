...
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_51_getDisplay,"Option","getDisplay",0x9ac5dc85,"Option.getDisplay","Options.hx",51,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_56_getAccept,"Option","getAccept",0x6ec11a25,"Option.getAccept","Options.hx",56,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_61_getDescription,"Option","getDescription",0xff3298bf,"Option.getDescription","Options.hx",61,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_66_press,"Option","press",0x2a2f91ea,"Option.press","Options.hx",66,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_67_updateDisplay,"Option","updateDisplay",0xbdef0ca0,"Option.updateDisplay","Options.hx",67,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_68_left,"Option","left",0xb77ad380,"Option.left","Options.hx",68,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_69_right,"Option","right",0x4b0b4a43,"Option.right","Options.hx",69,0x9d9a0240)

void Option_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_40_new)
HXLINE(  48)		this->acceptValues = false;
...
::String Option_obj::getDisplay(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_51_getDisplay)
HXDLIN(  51)		return this->display;
            	}
...
bool Option_obj::getAccept(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_56_getAccept)
HXDLIN(  56)		return this->acceptValues;
            	}
...
::String Option_obj::getDescription(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_61_getDescription)
HXDLIN(  61)		return this->description;
            	}
...
bool Option_obj::press(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_66_press)
...
::String Option_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_67_updateDisplay)
HXDLIN(  67)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("stub!",33,93,1a,84)));
...
bool Option_obj::left(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_68_left)
...
bool Option_obj::right(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_69_right)
