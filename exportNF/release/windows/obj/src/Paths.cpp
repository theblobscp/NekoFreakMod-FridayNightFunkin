...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_130_getPackerAtlasJson,"Paths","getPackerAtlasJson",0x36fdce17,"Paths.getPackerAtlasJson","Paths.hx",130,0x309ea470)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,getPackerAtlas,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getPackerAtlasJson(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_130_getPackerAtlasJson)
HXDLIN( 130)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 130)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromTexturePackerJson(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,getPackerAtlasJson,return )
...
bool Paths_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 15:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"getPackerAtlasJson") ) { outValue = getPackerAtlasJson_dyn(); return true; }
		break;
	case 19:
...
static ::String Paths_obj_sStaticFields[] = {
	...
	HX_("getPackerAtlasJson",b7,c4,0e,c8),
	::String(null())
};
