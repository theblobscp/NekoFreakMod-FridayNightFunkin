...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_685_update,"Character","update",0x0e18944e,"Character.update","Character.hx",685,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_721_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",721,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_782_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",782,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_813_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",813,0xf073a2d5)
...
HXLINE( 308)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("bf-confused",0a,55,5f,31)) ){
HXLINE( 418)			::String library = null();
HXDLIN( 418)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/bf_confused",83,34,df,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 418)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/bf_confused",83,34,df,72)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 419)			this->set_frames(tex1);
HXLINE( 420)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f),24,false,null(),null());
HXLINE( 421)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF NOTE UP0",23,e8,67,d4),24,false,null(),null());
HXLINE( 422)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("BF NOTE LEFT0",77,e0,7c,76),24,false,null(),null());
HXLINE( 423)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("BF NOTE RIGHT0",06,3f,26,eb),24,false,null(),null());
HXLINE( 424)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("BF NOTE DOWN0",bc,3f,f1,e1),24,false,null(),null());
HXLINE( 425)			this->animation->addByPrefix(HX_("singUPmiss",66,22,08,8a),HX_("BF NOTE UP MISS",8f,08,36,ae),24,false,null(),null());
HXLINE( 426)			this->animation->addByPrefix(HX_("singLEFTmiss",d2,2f,9c,b6),HX_("BF NOTE LEFT MISS",e3,ba,cf,a7),24,false,null(),null());
HXLINE( 427)			this->animation->addByPrefix(HX_("singRIGHTmiss",89,cc,65,e3),HX_("BF NOTE RIGHT MISS",f2,0c,cd,25),24,false,null(),null());
HXLINE( 428)			this->animation->addByPrefix(HX_("singDOWNmiss",ad,e9,88,e4),HX_("BF NOTE DOWN MISS",a8,a0,05,a9),24,false,null(),null());
HXLINE( 430)			this->addOffset(HX_("idle",14,a7,b3,45),-5,null());
HXLINE( 431)			this->addOffset(HX_("singUP",6a,52,21,b9),-29,27);
HXLINE( 432)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-38,-7);
HXLINE( 433)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),12,-6);
HXLINE( 434)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-10,-50);
HXLINE( 435)			this->addOffset(HX_("singUPmiss",66,22,08,8a),-29,27);
HXLINE( 436)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),-30,21);
HXLINE( 437)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),12,24);
HXLINE( 438)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),-11,-19);
HXLINE( 439)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 441)			this->set_flipX(true);
HXLINE( 417)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-fresh",e5,c3,72,7b)) ){
HXLINE( 393)			::String library = null();
HXDLIN( 393)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/bf_fresh",cc,6e,a9,96)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 393)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/bf_fresh",cc,6e,a9,96)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 394)			this->set_frames(tex1);
HXLINE( 395)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f),24,false,null(),null());
HXLINE( 396)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF NOTE UP0",23,e8,67,d4),24,false,null(),null());
HXLINE( 397)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("BF NOTE LEFT0",77,e0,7c,76),24,false,null(),null());
HXLINE( 398)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("BF NOTE RIGHT0",06,3f,26,eb),24,false,null(),null());
HXLINE( 399)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("BF NOTE DOWN0",bc,3f,f1,e1),24,false,null(),null());
HXLINE( 400)			this->animation->addByPrefix(HX_("singUPmiss",66,22,08,8a),HX_("BF NOTE UP MISS",8f,08,36,ae),24,false,null(),null());
HXLINE( 401)			this->animation->addByPrefix(HX_("singLEFTmiss",d2,2f,9c,b6),HX_("BF NOTE LEFT MISS",e3,ba,cf,a7),24,false,null(),null());
HXLINE( 402)			this->animation->addByPrefix(HX_("singRIGHTmiss",89,cc,65,e3),HX_("BF NOTE RIGHT MISS",f2,0c,cd,25),24,false,null(),null());
HXLINE( 403)			this->animation->addByPrefix(HX_("singDOWNmiss",ad,e9,88,e4),HX_("BF NOTE DOWN MISS",a8,a0,05,a9),24,false,null(),null());
HXLINE( 405)			this->addOffset(HX_("idle",14,a7,b3,45),-5,null());
HXLINE( 406)			this->addOffset(HX_("singUP",6a,52,21,b9),-29,27);
HXLINE( 407)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-38,-7);
HXLINE( 408)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),12,-6);
HXLINE( 409)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-10,-50);
HXLINE( 410)			this->addOffset(HX_("singUPmiss",66,22,08,8a),-29,27);
HXLINE( 411)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),-30,21);
HXLINE( 412)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),12,24);
HXLINE( 413)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),-11,-19);
HXLINE( 414)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 416)			this->set_flipX(true);
HXLINE( 392)			goto _hx_goto_0;
            		}
...
HXDLIN( 468)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfPixelsDEAD",fa,66,1f,36)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 468)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/bfPixelsDEAD",fa,66,1f,36)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 469)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF Dies pixel",d5,56,ac,77),24,false,null(),null());
HXLINE( 470)			this->animation->addByPrefix(HX_("firstDeath",e4,d8,fc,14),HX_("BF Dies pixel",d5,56,ac,77),24,false,null(),null());
HXLINE( 471)			this->animation->addByPrefix(HX_("deathLoop",b8,0b,79,2e),HX_("Retry Loop",5c,76,15,41),24,true,null(),null());
HXLINE( 472)			this->animation->addByPrefix(HX_("deathConfirm",2c,44,2b,12),HX_("RETRY CONFIRM",08,8c,5f,fd),24,false,null(),null());
HXLINE( 473)			this->animation->play(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
HXLINE( 475)			this->addOffset(HX_("firstDeath",e4,d8,fc,14),null(),null());
HXLINE( 476)			this->addOffset(HX_("deathLoop",b8,0b,79,2e),-37,null());
HXLINE( 477)			this->addOffset(HX_("deathConfirm",2c,44,2b,12),-37,null());
HXLINE( 478)			this->playAnim(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
HXLINE( 480)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 481)			this->updateHitbox();
HXLINE( 482)			this->set_antialiasing(false);
HXLINE( 483)			this->set_flipX(true);
HXLINE( 467)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-scared",c9,02,f4,15)) ){
HXLINE( 443)			::String library = null();
HXDLIN( 443)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/bf_scared",02,e2,92,ca)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 443)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/bf_scared",02,e2,92,ca)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 444)			this->set_frames(tex1);
HXLINE( 445)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f),24,false,null(),null());
HXLINE( 446)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF NOTE UP0",23,e8,67,d4),24,false,null(),null());
HXLINE( 447)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("BF NOTE LEFT0",77,e0,7c,76),24,false,null(),null());
HXLINE( 448)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("BF NOTE RIGHT0",06,3f,26,eb),24,false,null(),null());
HXLINE( 449)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("BF NOTE DOWN0",bc,3f,f1,e1),24,false,null(),null());
HXLINE( 450)			this->animation->addByPrefix(HX_("singUPmiss",66,22,08,8a),HX_("BF NOTE UP MISS",8f,08,36,ae),24,false,null(),null());
HXLINE( 451)			this->animation->addByPrefix(HX_("singLEFTmiss",d2,2f,9c,b6),HX_("BF NOTE LEFT MISS",e3,ba,cf,a7),24,false,null(),null());
HXLINE( 452)			this->animation->addByPrefix(HX_("singRIGHTmiss",89,cc,65,e3),HX_("BF NOTE RIGHT MISS",f2,0c,cd,25),24,false,null(),null());
HXLINE( 453)			this->animation->addByPrefix(HX_("singDOWNmiss",ad,e9,88,e4),HX_("BF NOTE DOWN MISS",a8,a0,05,a9),24,false,null(),null());
HXLINE( 455)			this->addOffset(HX_("idle",14,a7,b3,45),-5,null());
HXLINE( 456)			this->addOffset(HX_("singUP",6a,52,21,b9),-29,27);
HXLINE( 457)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-38,-7);
HXLINE( 458)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),12,-6);
HXLINE( 459)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-10,-50);
HXLINE( 460)			this->addOffset(HX_("singUPmiss",66,22,08,8a),-29,27);
HXLINE( 461)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),-30,21);
HXLINE( 462)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),12,24);
HXLINE( 463)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),-11,-19);
HXLINE( 464)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 466)			this->set_flipX(true);
...
HXLINE( 215)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("neko-bonus",2d,c3,28,7e)) ){
HXLINE( 625)			::String library = null();
HXDLIN( 625)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf4",43,0f,4b,c7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 625)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromTexturePackerJson(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf4",43,0f,4b,c7)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 627)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("nf4_idle",77,e0,8d,e8),24,false,null(),null());
HXLINE( 628)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("nf4_up",fe,70,c8,d8),24,false,null(),null());
HXLINE( 629)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("nf4_down",c5,31,48,e5),24,false,null(),null());
HXLINE( 630)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("nf4_left",6a,41,8a,ea),24,false,null(),null());
HXLINE( 631)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("nf4_right",19,09,7c,c5),24,false,null(),null());
HXLINE( 633)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 634)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 635)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 636)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 637)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 639)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 624)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("neko-crazy",9f,22,81,13)) ){
HXLINE( 590)			::String library = null();
HXDLIN( 590)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf2",41,0f,4b,c7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 590)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromTexturePackerJson(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf2",41,0f,4b,c7)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 592)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("nfc_idle",e8,d5,53,b3),24,false,null(),null());
HXLINE( 593)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("nfc_up",2f,78,d9,f7),24,false,null(),null());
HXLINE( 594)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("nfc_down",36,27,0e,b0),24,false,null(),null());
HXLINE( 595)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("nfc_left",db,36,50,b5),24,false,null(),null());
HXLINE( 596)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("nfc_right",88,d6,ec,67),24,false,null(),null());
HXLINE( 597)			this->animation->addByPrefix(HX_("singRIGHT-alt",a9,0c,12,b9),HX_("nfc_freeze",2b,16,4d,e8),24,false,null(),null());
HXLINE( 599)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 600)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 601)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 602)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 603)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 605)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 589)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("neko-schizo",38,d4,c3,c4)) ){
HXLINE( 608)			::String library = null();
HXDLIN( 608)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf3",42,0f,4b,c7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 608)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromTexturePackerJson(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf3",42,0f,4b,c7)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 610)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("nfb_idle",89,79,f8,4c),24,false,null(),null());
HXLINE( 611)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("nfb_up",90,41,30,f7),24,false,null(),null());
HXLINE( 612)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("nfb_down",d7,ca,b2,49),24,false,null(),null());
HXLINE( 613)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("nfb_left",7c,da,f4,4e),24,false,null(),null());
HXLINE( 614)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("nfb_right",c7,5f,57,3e),24,false,null(),null());
HXLINE( 616)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 617)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 618)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 619)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 620)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 622)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 607)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("neko-sweet",7e,72,3b,4d)) ){
HXLINE( 573)			::String library = null();
HXDLIN( 573)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf1",40,0f,4b,c7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 573)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromTexturePackerJson(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf1",40,0f,4b,c7)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 575)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("nfs_idle",d8,9b,09,19),24,false,null(),null());
HXLINE( 576)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("nfs_up",1f,e2,6c,02),24,false,null(),null());
HXLINE( 577)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("nfs_down",26,ed,c3,15),24,false,null(),null());
HXLINE( 578)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("nfs_left",cb,fc,05,1b),24,false,null(),null());
HXLINE( 579)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("nfs_right",98,42,44,01),24,false,null(),null());
HXLINE( 581)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 582)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 583)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 584)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 585)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 587)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 572)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("nekunt",27,44,cd,69)) ){
HXLINE( 642)			::String library = null();
HXDLIN( 642)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf5",44,0f,4b,c7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 642)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromTexturePackerJson(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("cat/nf5",44,0f,4b,c7)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 644)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("nf5_idle",d6,3c,e9,4e),24,false,null(),null());
HXLINE( 645)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("nf5_up",9d,a7,71,d9),24,false,null(),null());
HXLINE( 646)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("nf5_down",24,8e,a3,4b),24,false,null(),null());
HXLINE( 647)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("nf5_left",c9,9d,e5,50),24,false,null(),null());
HXLINE( 648)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("nf5_right",da,7f,11,ef),24,false,null(),null());
HXLINE( 650)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 651)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 652)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 653)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 654)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 656)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 641)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("parents-christmas",fe,94,c5,32)) ){
HXLINE( 547)			::String library = null();
HXDLIN( 547)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/mom_dad_christmas_assets",91,39,44,07)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 547)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/mom_dad_christmas_assets",91,39,44,07)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 548)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Parent Christmas Idle",c8,04,64,10),24,false,null(),null());
HXLINE( 549)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Parent Up Note Dad",88,99,f7,ad),24,false,null(),null());
HXLINE( 550)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Parent Down Note Dad",21,a5,93,34),24,false,null(),null());
HXLINE( 551)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Parent Left Note Dad",dc,f8,16,c4),24,false,null(),null());
HXLINE( 552)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Parent Right Note Dad",13,46,28,52),24,false,null(),null());
HXLINE( 554)			this->animation->addByPrefix(HX_("singUP-alt",86,62,b4,5f),HX_("Parent Up Note Mom",0c,7a,fe,ad),24,false,null(),null());
HXLINE( 556)			this->animation->addByPrefix(HX_("singDOWN-alt",cd,29,35,ba),HX_("Parent Down Note Mom",a5,85,9a,34),24,false,null(),null());
HXLINE( 557)			this->animation->addByPrefix(HX_("singLEFT-alt",f2,6f,48,8c),HX_("Parent Left Note Mom",60,d9,1d,c4),24,false,null(),null());
HXLINE( 558)			this->animation->addByPrefix(HX_("singRIGHT-alt",a9,0c,12,b9),HX_("Parent Right Note Mom",97,26,2f,52),24,false,null(),null());
HXLINE( 560)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 561)			this->addOffset(HX_("singUP",6a,52,21,b9),-47,24);
HXLINE( 562)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-1,-23);
HXLINE( 563)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-30,16);
HXLINE( 564)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-31,-29);
HXLINE( 565)			this->addOffset(HX_("singUP-alt",86,62,b4,5f),-47,24);
HXLINE( 566)			this->addOffset(HX_("singRIGHT-alt",a9,0c,12,b9),-1,-24);
HXLINE( 567)			this->addOffset(HX_("singLEFT-alt",f2,6f,48,8c),-30,15);
HXLINE( 568)			this->addOffset(HX_("singDOWN-alt",cd,29,35,ba),-30,-27);
HXLINE( 570)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
...
HXLINE( 486)			::String library = null();
HXDLIN( 486)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 486)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 487)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Senpai Idle",78,62,c5,a9),24,false,null(),null());
HXLINE( 488)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("SENPAI UP NOTE",f3,26,c1,c4),24,false,null(),null());
HXLINE( 489)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("SENPAI LEFT NOTE",c7,90,76,f3),24,false,null(),null());
HXLINE( 490)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("SENPAI RIGHT NOTE",3a,91,70,75),24,false,null(),null());
HXLINE( 491)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("SENPAI DOWN NOTE",8c,76,ac,f4),24,false,null(),null());
HXLINE( 493)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 494)			this->addOffset(HX_("singUP",6a,52,21,b9),5,37);
HXLINE( 495)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 496)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),40,null());
HXLINE( 497)			this->addOffset(HX_("singDOWN",31,2a,ad,36),14,null());
HXLINE( 499)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 501)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 502)			this->updateHitbox();
HXLINE( 504)			this->set_antialiasing(false);
HXLINE( 485)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("senpai-angry",10,7a,b8,25)) ){
HXLINE( 506)			::String library = null();
HXDLIN( 506)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 506)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/senpai",41,1d,ab,80)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 507)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Angry Senpai Idle",d9,cc,b4,52),24,false,null(),null());
HXLINE( 508)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Angry Senpai UP NOTE",52,97,34,df),24,false,null(),null());
HXLINE( 509)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Angry Senpai LEFT NOTE",e6,16,ee,25),24,false,null(),null());
HXLINE( 510)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Angry Senpai RIGHT NOTE",3b,66,8e,6b),24,false,null(),null());
HXLINE( 511)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Angry Senpai DOWN NOTE",ab,fc,23,27),24,false,null(),null());
HXLINE( 513)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 514)			this->addOffset(HX_("singUP",6a,52,21,b9),5,37);
HXLINE( 515)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 516)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),40,null());
HXLINE( 517)			this->addOffset(HX_("singDOWN",31,2a,ad,36),14,null());
HXLINE( 518)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 520)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 521)			this->updateHitbox();
HXLINE( 523)			this->set_antialiasing(false);
HXLINE( 505)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("spirit",31,bb,a9,bd)) ){
HXLINE( 526)			::String library = null();
HXDLIN( 526)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/spirit",36,f9,c6,d2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 526)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/spirit",36,f9,c6,d2)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 527)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("idle spirit_",02,2f,37,04),24,false,null(),null());
HXLINE( 528)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("up_",a4,29,59,00),24,false,null(),null());
HXLINE( 529)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("right_",03,55,26,4e),24,false,null(),null());
HXLINE( 530)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("left_",78,fe,56,72),24,false,null(),null());
HXLINE( 531)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("spirit down_",8e,9f,fa,ae),24,false,null(),null());
HXLINE( 533)			this->addOffset(HX_("idle",14,a7,b3,45),-220,-280);
HXLINE( 534)			this->addOffset(HX_("singUP",6a,52,21,b9),-220,-240);
HXLINE( 535)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-220,-280);
HXLINE( 536)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-200,-280);
HXLINE( 537)			this->addOffset(HX_("singDOWN",31,2a,ad,36),170,110);
HXLINE( 539)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 540)			this->updateHitbox();
HXLINE( 542)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 544)			this->set_antialiasing(false);
HXLINE( 525)			goto _hx_goto_0;
            		}
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE( 659)		this->dance();
HXLINE( 661)		if (( (bool)(isPlayer) )) {
HXLINE( 663)			this->set_flipX(!(this->flipX));
HXLINE( 666)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 669)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 670)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 671)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
HXLINE( 674)				if (::hx::IsNotNull( this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3)) )) {
HXLINE( 676)					::Array< int > oldMiss = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames;
HXLINE( 677)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames;
HXLINE( 678)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames = oldMiss;
            				}
            			}
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_685_update)
HXLINE( 686)		if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 688)			if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 690)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 690)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 693)			Float dadVar = ( (Float)(4) );
HXLINE( 695)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 696)				dadVar = ((Float)6.1);
            			}
HXLINE( 697)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 699)				this->dance();
HXLINE( 700)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 704)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 707)			bool _hx_tmp;
HXDLIN( 707)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 707)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
HXLINE( 707)				_hx_tmp = false;
            			}
HXDLIN( 707)			if (_hx_tmp) {
HXLINE( 708)				this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            			}
            		}
HXLINE( 711)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_721_dance)
HXDLIN( 721)		if (!(this->debugMode)) {
HXLINE( 723)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 726)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 728)					this->danced = !(this->danced);
HXLINE( 730)					if (this->danced) {
HXLINE( 731)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 733)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 726)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
HXLINE( 748)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 750)					this->danced = !(this->danced);
HXLINE( 752)					if (this->danced) {
HXLINE( 753)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 755)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 748)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
HXLINE( 737)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 739)					this->danced = !(this->danced);
HXLINE( 741)					if (this->danced) {
HXLINE( 742)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 744)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 737)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 758)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 760)					this->danced = !(this->danced);
HXLINE( 762)					if (this->danced) {
HXLINE( 763)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 765)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 758)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
HXLINE( 769)				this->danced = !(this->danced);
HXLINE( 771)				if (this->danced) {
HXLINE( 772)					this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            				}
            				else {
HXLINE( 774)					this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            				}
HXLINE( 768)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 776)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_782_playAnim)
HXLINE( 783)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 785)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 786)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 788)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 791)			this->offset->set(0,0);
            		}
HXLINE( 793)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 795)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 797)				this->danced = true;
            			}
            			else {
HXLINE( 799)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 801)					this->danced = false;
            				}
            			}
HXLINE( 804)			bool _hx_tmp;
HXDLIN( 804)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 804)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 804)				_hx_tmp = true;
            			}
HXDLIN( 804)			if (_hx_tmp) {
HXLINE( 806)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_813_addOffset)
HXDLIN( 813)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 813)		this->animOffsets->set(name,v);
            	}
