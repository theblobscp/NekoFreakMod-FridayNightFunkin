...
HX_DEFINE_STACK_FRAME(_hx_pos_e90bf299ab00f44e_168_new,"SongPositionOption","new",0xf73dda45,"SongPositionOption.new","Options.hx",168,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_173_press,"SongPositionOption","press",0xd57460a8,"SongPositionOption.press","Options.hx",173,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_181_updateDisplay,"SongPositionOption","updateDisplay",0x1eddc95e,"SongPositionOption.updateDisplay","Options.hx",181,0x9d9a0240)

void SongPositionOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_168_new)
HXLINE( 169)		super::__construct();
HXLINE( 170)		this->description = desc;
            	}
...
bool SongPositionOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_173_press)
HXLINE( 174)		::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 175)		this->display = this->updateDisplay();
HXLINE( 176)		return true;
            	}


::String SongPositionOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_181_updateDisplay)
HXDLIN( 181)		::String _hx_tmp;
HXDLIN( 181)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) ))) {
HXDLIN( 181)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 181)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 181)		return (HX_("Song Position ",4c,83,da,f1) + _hx_tmp);
            	}
