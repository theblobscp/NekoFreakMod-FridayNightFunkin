...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'the-date':
				dialogue = CoolUtil.coolTextFile(Paths.txt('the-date/nekoDialogue'));
			case 'red-flag':
				dialogue = CoolUtil.coolTextFile(Paths.txt('red-flag/nekoDialogue'));
			case 'gtfo':
				dialogue = CoolUtil.coolTextFile(Paths.txt('gtfo/nekoDialogue'));
		}
        ...
        // Setting the background for both variants.
